...
def main():
    ...
    Musk's political activities, views, and statements have made him a polarizing figure, especially following the COVID-19 pandemic. He has been criticized for making unscientific and misleading statements, including COVID-19 misinformation and promoting conspiracy theories```
    """

    summary_template = """
    Given the {information} about a person I want you to create:
    1. A very short summary of the person in 2 sentences.
